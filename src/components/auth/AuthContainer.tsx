  ...
  return (
    ...
    >
      ...
      <div className="fixed top-6 right-6 z-50">
        <div className="p-3 rounded-full backdrop-blur-md shadow-lg border" 
             style={{ 
        ...
        <div className="grid lg:grid-cols-2 gap-0 min-h-[700px] rounded-3xl overflow-hidden shadow-2xl">
          ...
          {isLogin ? (
            <>
              ...
              <div 
                className="relative p-12 flex flex-col justify-center text-center lg:text-left order-2 lg:order-1"
                style={{ 
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  {/* Decorative Elements */}
                  <div className="flex items-center justify-center lg:justify-start space-x-2 opacity-30">
              ...
              <div 
                className="relative p-12 flex flex-col justify-center backdrop-blur-xl order-1 lg:order-2"
                style={{ 
                  backgroundColor: theme.colors.surface + 'f0',
            ...
            <>
              ...
              <div 
                className="relative p-12 flex flex-col justify-center text-center lg:text-left order-2"
                style={{ 
                  background: `linear-gradient(135deg, ${theme.colors.primary}, ${theme.colors.secondary})` 
                }}
              >
